...
namespace snark{
  ...
  void generate_mimc_roundconst_gfp(std::vector< NTL::ZZ_p > &roundconst, int numround);
  ...
  public:
    ...
    mimc_em_snark();
    mimc_em_snark(unsigned long int block_size, std::vector<field_t> round_const):
      xorCount(0), multCount(0), blockSize(block_size), roundConst(round_const)
    {
